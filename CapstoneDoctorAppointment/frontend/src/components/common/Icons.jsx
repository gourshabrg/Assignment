...
export const StethoscopeIcon = (props) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" {...props}>
    <path
      d="M6 3v5a4 4 0 008 0V3"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinecap="round"
    />
    <path
      d="M10 12v2a5 5 0 0010 0v-1"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinecap="round"
    />
    <circle cx="20" cy="11" r="2" stroke="currentColor" strokeWidth="1.8" />
  </svg>
);
...
export const UsersIcon = (props) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <path
      d="M16 5.5a3 3 0 010 5.8M17 20a6 6 0 00-2-4.4"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinecap="round"
    />
